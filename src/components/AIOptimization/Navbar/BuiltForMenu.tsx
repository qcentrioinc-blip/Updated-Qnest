...
bg-gray-50  px-24 py-8 shadow-xl z-[9998]
...
${isScrolled
    ...
    >
      <H3 className="">Engineered for Every Industry Need </H3>
      ...
      <div className="grid grid-cols-3 gap-y-4 gap-x-1">
        {builtForItemsAI.map((item, index) => (
          <Link key={index} to={item.path} onClick={onLinkClick} className="block cursor-pointer pointer-events-auto hover:bg-gray-100 pt-2 rounded-lg transition-colors">
